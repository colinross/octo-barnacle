...
Amber::Server.configure do |settings|
  ...
  #
  settings.name = "Octo Barnacle web application."
  #
  #
  ...
  #
  # settings.secret_key_base= E15vaOSPQIhZc3rc6fnQG9ma6C85s_GKeplzgDTvEDg
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("octo-barnacle.log", "w"))
  #
  #
end
